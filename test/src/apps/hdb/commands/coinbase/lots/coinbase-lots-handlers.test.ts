...
const {
  ...
  traceCoinbaseBalanceLedgerMock: vi.fn(() => Promise.resolve([
    { id: "1", asset: "BTC", timestamp: dateUtc({ year: 2025, month: 12, day: 1 }), balance: "0", tx_id: "synthetic-zero-BTC", notes: "seed" },
    { id: "2", asset: "BTC", timestamp: dateUtc({ year: 2025, month: 12, day: 15 }), balance: "2", tx_id: "buy-old", notes: "buy" },
  ])),
  ...
  selectCoinbaseTransactionsByIdsMock: vi.fn(() => Promise.resolve([
    {
      id: "buy-old",
      timestamp: dateUtc({ year: 2025, month: 12, day: 15 }),
      type: "Buy",
      asset: "BTC",
      num_quantity: "2",
      num_price_at_tx: "100",
